...
hook.Add( "InitPostEntity", "LoadZSDermaSkin", function()
	...
	local texCorner = surface.GetTextureID("gui/circlegradient")
	...
	derma.DefineSkin("zsvotemap", "The default Derma skin for Zombie Survival", SKIN, "Default") -- Renamed the skin to prevent override.
end )